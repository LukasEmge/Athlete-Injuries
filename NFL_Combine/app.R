...
ui <- fluidPage(
    ...
    navbarPage(
        ...
        tabPanel("About",
                 ...
                 br(),
                 h1("Implications"),
                 p("This data analysis has implications on how players train
                   for the NFL Combine. Many athletes spend a lot of time and 
                   money training for each event, but if it is found that
                   certain events have no bearing on draft position, then their 
                   time and money may be better spent of the events that have
                   a correlation with improving draftr position. This data may
                   also cause teams to realize they have drafting tendencies 
                   that do not fit and match their intended scheme."),
                 h1("About the Data"),
